...
export async function sendEmail(
    ...
    try {
        ...
        sendSmtpEmail.textContent =
            params.textContent || params.htmlContent.replace(/<[^>]*>/g, "");
        sendSmtpEmail.sender = { name: "Bellu", email: "noreply@bellu.ai" };
...
export function generateVerificationEmail(
    ...
    const subject = "Verify your email for Bellu integration";
    ...
    <head>
        <meta charset="utf-8">
        <title>Email Verification - Bellu</title>
        <style>
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p class="text">Welcome to Bellu! To complete your seller onboarding and activate our 10-minute delivery infrastructure for your brand, please verify your email address.</p>
            ...
            <div class="footer">
                <p>© 2024 Bellu - India's Fastest Delivery Infrastructure</p>
